...
export const BeforeAfterSection = () => (
  <AnimatedSection className="py-16 md:py-24 bg-gray-50">
    <div className="container mx-auto px-4 text-center">
      <h2 className="text-3xl md:text-4xl font-bold text-gray-800">Приклад трансформації після програми</h2>
        ...
        <Card className="overflow-hidden shadow-lg">
          ...
          <CardContent className="p-4 bg-white">
            ...
            <p className="text-sm text-gray-600 text-center">
              Фізичне виснаження, емоційна нестабільність, втрата зв'язку з родиною
            </p>
          </CardContent>
        </Card>
        <Card className="overflow-hidden shadow-lg">
          <Image
            ...
            alt="Людина після перебування в центрі"
            width={500}
            height={500}
            className="w-full h-auto object-cover"
          />
          <CardContent className="p-4 bg-white">
            ...
            <p className="text-sm text-gray-600 text-center">
              Здорове тіло, емоційна стабільність, відновлені стосунки, повноцінне життя
            </p>
          </CardContent>
        </Card>
      </div>
