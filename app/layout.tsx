...
export const metadata: Metadata = {
  title: "Навчально-духовний центр \"Перемога\" | Звільнення від залежностей в Україні",
  description:
    "Центр реабілітації та духовного відновлення в Івано-Франківську і Запоріжжі. Безкоштовна допомога у звільненні від алкогольної, наркотичної та ігрової залежності. Християнський підхід, досвідчені наставники.",
  generator: "v0.dev",
  robots: "index, follow",
}
